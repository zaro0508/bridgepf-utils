...
public class BridgeSpringConfig {
    ...
    public AmazonDynamoDBClient dynamoDbClient() {
        ...
        if (awsCredentials().getAWSAccessKeyId().equals("AWS")) {
            return new AmazonDynamoDBClient(awsClientConfig);
        } else {
    ...
    public AmazonSNSClient snsClient() {
        if (snsCredentials().getAWSAccessKeyId().equals("AWS")) {
    ...
    public AmazonS3Client s3UploadClient(BasicAWSCredentials s3UploadCredentials) {
        if (s3UploadCredentials.getAWSAccessKeyId().equals("AWS")) {
            return new AmazonS3Client();
        } else {
    ...
    public AmazonS3Client s3CmsClient(BasicAWSCredentials s3CmsCredentials) {
        if (s3CmsCredentials.getAWSAccessKeyId().equals("AWS")) {
            return new AmazonS3Client();
        } else {
    ...
    public AmazonS3Client s3ConsentsClient(BasicAWSCredentials s3ConsentsCredentials) {
        if (s3ConsentsCredentials.getAWSAccessKeyId().equals("AWS")) {
            return new AmazonS3Client();
        } else {
            return new AmazonS3Client(s3ConsentsCredentials);
        }
    }
    ...
    public AmazonSimpleEmailServiceClient sesClient(BasicAWSCredentials awsCredentials) {
        if (awsCredentials.getAWSAccessKeyId().equals("AWS")) {
            return new AmazonSimpleEmailServiceClient(new InstanceProfileCredentialsProvider());
        } else {
    ...
    public AmazonSQSClient sqsClient(BasicAWSCredentials awsCredentials) {
        if (awsCredentials.getAWSAccessKeyId().equals("AWS")) {
            return new AmazonSQSClient(new InstanceProfileCredentialsProvider());
        } else {
